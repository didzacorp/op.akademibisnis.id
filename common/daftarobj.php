...
function createDialog($fmID='divdialog1',
	...
	$ContentWidth=623,
	$ContentHeight=358,
	$caption='Dialog',$ukuran='md', $dlgCaptionContent='',
	...
	$marginTop= 9;
		...
		$marginRight = 8;
	$menudlg = "
			<div style='padding: 0 $paddingMenuRight $paddingMenuBottom $paddingMenuLeft;min-height: 44px; '>
   ...
   $footerDialog = $ContentHeight - 15;
	if($params == NULL){
		...
		if ($ukuran == 'full') {
			...
			$modal = 'modal-dialog modal-'.$ukuran;
		}
		$dlg = "<div id='div_border' style='
				background-color: white;
				border-color: rgba(0, 0, 0, 0.3);
				border-style: solid;
				border-width: 1px;
...
class AppCls{
    ...
    <link rel='stylesheet' href='assets/rm-rf-ui/vendors/mdi/css/materialdesignicons.min.css'>
    <link rel='stylesheet' href='assets/rm-rf-ui/vendors/puse-icons-feather/feather.css'>
    <link rel='stylesheet' href='assets/rm-rf-ui/vendors/css/vendor.bundle.base.css'>
    <!-- endinject -->
    <!-- plugin css for this page -->
    <link rel='stylesheet' href='assets/rm-rf-ui/vendors/font-awesome/css/font-awesome.min.css'/>
    <link rel='stylesheet' href='assets/rm-rf-ui/vendors/jquery-bar-rating/css-stars.css'>
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel='stylesheet' href='assets/rm-rf-ui/css/style.css'>
    <link rel='stylesheet' href='assets/rm-rf-ui/fab/css/index.css'>
    <!-- endinject -->
    <link rel='shortcut icon' href='assets/rm-rf-ui/images/favicon.png' />
    ...
    <script src='assets/rm-rf-ui/vendors/js/vendor.bundle.base.js'></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <script src='assets/rm-rf-ui/vendors/chart.js/Chart.min.js'></script>
    <script src='assets/rm-rf-ui/vendors/jquery-bar-rating/jquery.barrating.min.js'></script>
    <script src='assets/rm-rf-ui/vendors/jquery-sparkline/jquery.sparkline.min.js'></script>
    <script src='assets/rm-rf-ui/vendors/progressbar.js/progressbar.min.js'></script>
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src='assets/rm-rf-ui/js/off-canvas.js'></script>
    <script src='assets/rm-rf-ui/js/hoverable-collapse.js'></script>
    <script src='assets/rm-rf-ui/js/misc.js'></script>
    <script src='assets/rm-rf-ui/js/settings.js'></script>
    <script src='assets/rm-rf-ui/js/todolist.js'></script>
    <script src='assets/rm-rf-ui/js/tooltips.js'></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src='assets/rm-rf-ui/js/dashboard.js'></script>

	<script src='js/jquery.js' type='text/javascript'></script>
	<script src='assets/rm-rf-ui/js/freeze-table.js'></script>
    ...
    <script src='assets/rm-rf-ui/fab/js/index.js' type='text/javascript'></script>
    <script>
	    $(function () {
...
<nav class='navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-success'>
      <div class='text-center navbar-brand-wrapper d-flex align-items-center justify-content-center'>
        <a class='navbar-brand brand-logo' href='index.html'><img style='width: 45%;'  src='assets/rm-rf-ui/images/logo/images.png' alt='logo'/></a>
        <a class='navbar-brand brand-logo-mini' href='index.html'><img style='width: 55%;'  src='assets/rm-rf-ui/images/logo/logo.png' alt='logo'/></a>
      </div>
      <div class='navbar-menu-wrapper d-flex align-items-stretch' >
        <a href='javascript:void(0);' class='navbar-toggler navbar-toggler align-self-center' data-toggle='minimize' id='resizeContent'>
...
<div class='zoom'>
    <a class='zoom-fab zoom-btn-large' id='zoomBtn'>
    	<i class='fa fa-ellipsis-h' style='line-height: 3;'></i>
    </a>
    <ul class='zoom-menu'>
     ".$this->setMenuEdit()."
    </ul>
...
//DAFTAR ========================================
	...
	function genTableAttribute ($class_){
		$tableAttribute = " border='1'   style='min-width: 100%;border: 1px solid #b0b0b2;' id='tech-companies-1'";
		return "<div class='".$this->Prefix."_table' style='width: 100%;' >
					<table class='table table-sm table-striped table-hover' $tableAttribute >";
	}
	...
	function genTableRow($Koloms, $RowAtr='', $KolomClassStyle='', $cb=0){
		...
		if (count($Koloms)>0){
			...
			$baris ="<tr $RowAtr onclick=\"".$this->Prefix.".rowOnClick(this)\" ondblclick=\"".$this->Prefix.".rowOnDblClick(this)\"> $baris </tr>";
		}
		return $baris;
	}
	...
	function genDaftarInitial(){
		...
		$divHal = "<div id='{$this->Prefix}_cont_hal' style='position:relative;background: #ffffff;width:100%'>".
		...
		switch($this->daftarMode){
			...
			default :{
				$vdaftar =
					"<div id='{$this->Prefix}_cont_daftar' style='position:relative;margin-top: 5%;' class='col col-md-12'>"."</div>".
					$divHal;
				break;
			}
		}
		...
		return
			//$NavAtas.
			// "<div id='{$this->Prefix}_cont_title' style='position:relative' class='col col-md-12'></div>".
			// "<div id='{$this->Prefix}_cont_skpd' name='{$this->Prefix}_cont_skpd' class='col col-md-12'> </div> ".
			"<div id='{$this->Prefix}_cont_opsi' style='position:relative;width: 100%;' class='col col-md-12'>".
				//$vOpsi['TampilOpt'].
			"</div>".
...
//PAGE ===========================================
	...
	function pageShow(){
		              ...
		              <div class='card'>
		                <div class='card-body'>
		                  <h4 class='card-title' style='margin-left: -14px;'>"
		                  	.$this->setTitle()."<hr>".
		                  	"<a class='btn btn-warning btn-sm pull-right' style='color:white;'
		                  	    data-toggle='collapse' href='#fillterContent-".$this->Prefix."'
		                  	    aria-expanded='false' aria-controls='fillterContent-".$this->Prefix."'
		                  	 >
		                  		<i class='fa fa-search'></i>
		                  	</a>".
		                  "</h4>
		                  <div class='row' style='width: 100%;margin: 0px;'>
                      <form name='".$this->FormName."' id='".$this->FormName."' style='width: 100%;'>
		                    ".$this->setPage_Content()."
                        </form>
		                  </div>
		                </div>
		...
		"<script>
	   		function TableResponsive(){
	    		$('.".$this->Prefix."_table').freezeTable({
	             'scrollBar': true,
	             'headWrapStyles': {'top': '58px','width': '100px'},
	             'columnNum' : 2,
	            });
	    	}
  ...
  function sideBar(){
    ...
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refMember'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Member</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refUsers'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Users</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refCopywriting'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Copywriting</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refFunnel'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Funnel / Landing Page</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refTraining'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Training</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refProduk'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Produk</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=refNews'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>News</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=modulTransaksi'>
            <i class='icon-server menu-icon'></i>
            <span class='menu-title'>Transaksi</span>
        </a>
    </li>
    <li class='nav-item'>
        <a class='nav-link' href='pages.php?Pg=inboxNotif'>
            <i class='icon-server menu-icon'></i>
